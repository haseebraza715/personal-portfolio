export function createConnectionSection(): HTMLElement {
  ...
  section.innerHTML = `
    <div class="max-w-5xl mx-auto flex flex-col items-center text-center">
      <h2 class="font-header text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-8 lg:mb-12">
      ...
      <div class="flex flex-col md:flex-row items-center gap-8 md:gap-12">
        <a href="mailto:haseeb.javed715@gmail.com" 
           class="group relative font-body text-base md:text-lg text-text/70 hover:text-text transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 rounded-lg px-1">
        ...
        <div class="flex items-center gap-6">
          <a href="https://github.com/haseebraza715" target="_blank" rel="noopener noreferrer" 
             class="group text-text/50 hover:text-accent transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 rounded">
      ...
      <p class="font-body text-xs text-text/40 mt-20">
