...
export function createNavbar(): HTMLElement {
  ...
  nav.innerHTML = `
    ...
    <div class="px-6 h-16 md:px-12 lg:px-32 flex items-center justify-between max-w-7xl mx-auto relative content-center">
      ...
      <!-- Logo / Brand -->
      <!-- Logo / Brand -->
      <a href="#identity" class="nav-brand font-header text-2xl font-extrabold tracking-tight text-text hover:text-accent transition-colors duration-200 z-[1002] relative" aria-label="Home">
        HR
      </a>
